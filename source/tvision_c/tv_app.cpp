...
/* ------------------------------------------------------------------------*/
/*   TCApplication - Subclass to expose TApplication's protected          */
/*   constructor for C wrapper usage                                      */
/*                                                                         */
/*   TApplication has a protected constructor in the original Turbo       */
/*   Vision library, which prevents direct instantiation. TCApplication   */
/*   provides a public constructor that delegates to TApplication's       */
/*   protected constructor, allowing the C wrapper to create instances.   */
/*                                                                         */
/*   This class supports optional callback functions for creating custom  */
/*   status lines, menu bars, and handling events.                        */
/* ------------------------------------------------------------------------*/
